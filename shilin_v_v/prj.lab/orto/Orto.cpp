...
Reader* Reader::p_instance = nullptr;
//ReaderDestroyer Reader::destroyer;

ReaderDestroyer::~ReaderDestroyer() {
  delete p_instance;
}

void ReaderDestroyer::initialize(Reader* p) {
  p_instance = p;
}

Reader& Reader::getInstance() {
  if (!p_instance) {
    p_instance = new Reader();
